              ...
              <?php if ($_REQUEST['act']=="general_voucher"){ ?>
                   ...
                   <div class="col-sm-12">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" readonly value="<?=@$voucher['voucher_amount']?>" id="voucher_credit1" name="voucher_credit" class="form-control">
                      </div>
              ...
              <?php }elseif ($_REQUEST['act']=="expense_voucher") {
               ...
               <div class="col-sm-12">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="number" onkeyup="sameValue(this.value,'#voucher_credit')" min="0" name="voucher_debit" class="form-control" value="<?=@$voucher['voucher_amount']?>">
                      </div>
                    </div>  <!-- end of formgr0up -->
                    <div class="form-group row">
