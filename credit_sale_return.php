        ...
        <div class="card-header card-bg" align="center">
          ...
          <div class="row">
            <div class="col-12 mx-auto h4">
              <b class="text-center card-text pb-3">Credit Sale Return</b>
...
");
                ...
                <input type="text" name="next_increment" id="next_increment"
                  value="<?= @empty($_REQUEST['edit_order_id']) ? $next_increment : $fetchOrder['order_id'] ?>" readonly
                  class="form-control">
              </div>
              <div class="col-md-2">
              ...
              <div class="col-sm-3">
                ...
                <div class="input-group">
                  ...
                  <select class="form-control" onchange="getBalance(this.value,'customer_account_exp')"
                    name="credit_order_client_name" id="credit_order_client_name" required aria-label="Username"
                  ...
                  <tfoot>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6 pr-0">
                            ...
                            <input onkeyup="getOrderTotal()" type="number" id="ordered_discount"
                              ...
                              max="100" name="ordered_discount">

                          </div>
                          <div class="col-sm-6 pl-0">
                            <input onkeyup="getOrderTotal()" type="number" id="freight"
                              class="form-control form-control-sm " placeholder="Freight"
                              value="<?= @$fetchOrder['freight'] ?>" min="0" name="freight">
                    ...
                    <tr>
                      ...
                      <td class="table-bordered">
                        <div class="form-group row">
                          <div class="col-sm-6">
                            <input type="text" min="0" class="form-control form-control-sm" id="paid_ammount" required
                              onkeyup="getRemaingAmount()" name="paid_ammount"
